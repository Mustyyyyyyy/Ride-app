...
const navItems = [
  ...
  { href: "/driver/available-rides", label: "Available Rides", icon: "🛰️" },
  { href: "/driver/rides", label: "My Trips", icon: "🚗" },
  { href: "/driver/wallet", label: "Wallet", icon: "💰" },
  { href: "/driver/notifications", label: "Notifications", icon: "🔔" },
        ...
        <div className="mb-6 border-b border-white/10 pb-5">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Driver Panel</p>
            </div>
          </Link>
        </div>
